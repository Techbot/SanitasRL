...
Monster.prototype.pathfind = function(sx, sy, dx, dy, dungeon) {
    ...
    if(dungeon.cells[suggestedPosition.x][suggestedPosition.y].entityPasses === true
    ...
    if(dungeon.cells[suggestedPosition.x][sy].entityPasses === true
    ...
    if(dungeon.cells[sx][suggestedPosition.y].entityPasses === true
    ...
    if(suggestedPosition.x === sx
        ...
        if(dungeon.cells[suggestedPosition.x + 1][suggestedPosition.y].entityPasses === true
    ...
    if(suggestedPosition.y === sy
        ...
        // try up - diagonally
        if(dungeon.cells[suggestedPosition.x][suggestedPosition.y - 1].entityPasses === true
